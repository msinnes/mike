...
jest.mock('@core/utils/privateVariable');
const privateVariableMock = require('@core/utils/privateVariable');
const privateVariableActual = jest.requireActual('@core/utils/privateVariable');
...
const extendMock = require('../../src/lib/extendClass');
const extendActual = jest.requireActual('../../src/lib/extendClass');
jest.mock('../../src/lib/extendsClass');
const extendsClassMock = require('../../src/lib/extendsClass');
const extendsClassActual = jest.requireActual('../../src/lib/extendsClass');
...
describe('classLoader', () => {
  ...
  describe('loadClass output', () => {
    ...
    it('should retain static properties', () => {
      expect(LoadedProtoAndStatic.addTwo).toBeInstanceOf(Function);
      expect(LoadedProtoAndStatic.addTwo(2)).toEqual(4);
      expect(LoadedStatic.getText).toBeInstanceOf(Function);
      expect(LoadedStatic.getText()).toEqual('some text');
    });
    ...
    describe('instances', () => {
      ...
      it('should get prototype properties on instances', () => {
        expect(instance.addOne).toBeInstanceOf(Function);
      ...
      it('should inherit prototype and static properties through extension', () => {
        ...
        expect(BareExtendsAll.addTwo(1)).toEqual(3);
        expect(BareExtendsAll.getText()).toEqual('some text');
